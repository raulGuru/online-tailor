        ...
        <div class="row">
            <div class="col-2 border-end">
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('account.address') }}" role="button" class="btn btn-primary mb-3">Address</a>
                </div>
            </div>
            <div class="col">
                <form method="post" action="{{ route('user.update', $user->id) }}">
                    @csrf
                    @method('PATCH')
                    <input type="hidden" name="update_for" value="address" />
                    <div class="row mb-3">
                        <h1>Address page is pending</h1>
                    </div>
