                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="auth" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                           ...
                           Password <span class="sidebar-badge badge bg-primary">Pro</span></a>
                            </li>
                    ...
                    <li class="sidebar-item">
                     ...
                     Plugins</span>
                        ...
                        <ul id="form-plugins" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                           ...
                           Inputs <span class="sidebar-badge badge bg-primary">Pro</span></a>
                            </li>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="datatables" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                           ...
                           with Buttons <span class="sidebar-badge badge bg-primary">Pro</span></a>
                            </li>
                           ...
                           Selection <span class="sidebar-badge badge bg-primary">Pro</span></a>
                            </li>
                            <li class="sidebar-item"><a class="sidebar-link" href="tables-datatables-ajax.html">Ajax
                           Sourced Data <span class="sidebar-badge badge bg-primary">Pro</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
