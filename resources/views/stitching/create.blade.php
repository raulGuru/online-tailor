...
<div class="card">
    <div class="card-body">
        ...
        <form method="post" action="{{ route('stitching.store') }}">
            @csrf
            <div class="row mb-3">
                <div class="col-sm-4 mb-3">
                    <label class="mb-1">Stitching Name<span class="text-danger">*</span></label>
                    <input class="form-control form-control-lg" type="text" name="stitch_name" value="{{ old('stitch_name') }}" required placeholder="Enter stitching name" />
                    @error('stitch_name')
                ...
                <div class="col-sm-3 mb-3">
                    ...
                    <input class="form-control form-control-lg" type="number" name="cost" value="{{ old('cost') }}" step="any" required placeholder="Enter stitching cost" />
                    @error('cost')
                        <span class="alert alert-danger alert-dismissible mt-1">
                            <div class="alert-message p-0">
                                {{ $message }}
