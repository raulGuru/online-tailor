      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card-body text-left">
               <div class="mb-2">Creator: <span class="text-muted">{{ $category->user->email }}<span></div>
               <div class="mb-2">Product Category Name: <span class="text-muted">{{ $category->name }}<span></div>
               <div class="mb-2">Status: <span class="text-muted">{{ $category->action }}<span></div>
            </div>
        </div>
      </div>
      @else: 
