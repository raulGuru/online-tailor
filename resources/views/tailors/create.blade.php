        ...
        <form method="post" action="{{ route('tailors.store') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-4 mt-3 mb-3">
                    ...
                    <input class="form-control form-control-lg" type="number" min="0" max="100" required name="commission" value="{{ old('commission') }}" placeholder="Enter tailor's commission" />
                    @error('commission')
                        <span class="alert alert-danger alert-dismissible mt-1">
                            <div class="alert-message p-0">
                                {{ $message }}
